...
| 15  | [H2 In-Memory Database](https://github.com/jatinsoni08/Spring-Practice/tree/main/SpringBoot_H2Database)            | H2 Embedded Database, jdbc:h2:mem:testdb, H2 Console, ddl-auto=update, JpaRepository, In-Memory vs Persistent DB, Spring Data JPA, Zero-Config DB Setup | ✅ Complete |

| 16 | [JPQL & HQL Queries](https://github.com/jatinsoni08/Spring-Practice/tree/main/SpringBoot_JPQL_HQL_IMPL) | JPQL, HQL, @Query annotation, Parameter Binding (?1), Custom Finder Methods, Entity-based Queries, H2 In-Memory DB, Spring Data JPA | ✅ Complete |
...
| #   | Project Name                                                                                                               | Key Concepts                                         | Status      |
| --- | -------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ----------- |
| 17  | [MVC with ModelAndView](https://github.com/jatinsoni08/Spring-Practice/tree/main/SpringWebMVC_Project_UsingMVC)            | DispatcherServlet, HandlerMapping, JSP View Resolver | ✅ Complete |
| 18  | [Model & String View](https://github.com/jatinsoni08/Spring-Practice/tree/main/SpringWebMVCProject_UsingString)            | Model Object, Custom View Paths, JSP EL              | ✅ Complete |
| 19  | [Advanced Data Transfer](https://github.com/jatinsoni08/Spring-Practice/tree/main/SpringWebMVC_Project_Model_Map_ModelMap) | ModelMap, JSTL c:forEach, List Rendering             | ✅ Complete |
| 20  | [Thymeleaf Integration](https://github.com/jatinsoni08/Spring-Practice/tree/main/SpringWebMVC_Project_ThymeLeaf)           | Thymeleaf Engine, th:text, th:href, Static Resources | ✅ Complete |
...
| #   | Project Name                                                                                                             | Key Concepts                                                                                                                                                                                                                                   | Status      |
| --- | ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| 21  | [REST Basics](https://github.com/jatinsoni08/Spring-Practice/tree/main/SpringBoot_RESTBasicProject)                      | @RestController, @RequestBody, JSON Serialization, Postman                                                                                                                                                                                     | ✅ Complete |
| 22  | [Advanced REST](https://github.com/jatinsoni08/Spring-Practice/tree/main/SpringBoot_RESTPathVaribale_EG)                 | @PathVariable, @RequestParam, ResponseEntity, HttpStatus                                                                                                                                                                                       | ✅ Complete |
| 23  | [JSON Control](https://github.com/jatinsoni08/Spring-Practice/tree/main/SpringBoot_ResponseBody)                         | @JsonProperty, @JsonIgnore, @ResponseBody, Custom Responses                                                                                                                                                                                    | ✅ Complete |
| 24  | [Spring Security](https://github.com/jatinsoni08/Spring-Practice/tree/main/01SpringSecurity-BaiscProject)                | Default Behavior, Login Form, CSRF Token, Session ID, Stateful vs Stateless, Authentication vs Authorization, SecurityConfiguration, @EnableWebSecurity, SecurityFilterChain, In-Memory Auth, ADMIN + USER roles                               | ✅ Complete |
...
| 26  | [DAO Authentication](https://github.com/jatinsoni08/Spring-Practice/tree/main/02SpringSecurityProject)                   | DAO Authentication, DaoAuthenticationProvider, UserDetailsService Custom Implementation, UserDetails Adapter Class, IUserRepo + findByName(), Users Entity, MySQL Multi-User Auth, NoOpPasswordEncoder, Spring Data JPA + Security Integration | ✅ Complete |
| 27  | [OAuth2 Login](https://github.com/jatinsoni08/Spring-Practice/tree/main/03SpringSecurityProject_OAuth2Client)            | OAuth2 Client, Google OAuth2, GitHub OAuth2, oauth2Login(), SecurityFilterChain, Authorization Code Flow, Google Cloud Console, GitHub Developer Settings, Third-Party Authentication                                                          | ✅ Complete |
