...
public class UserRestController {
	...
	public ResponseEntity<User> getOneObj() {
		...
		User ob = new User(101, "ABC", "Dev", "PASSWD1234",
				Arrays.asList("P1", "P2"), Map.of("M1", "AA", "M2", "AB"));
	...
	public ResponseEntity<List<Role>> getAllRoles() {
		...
		List<Role> roles = Arrays.asList(new Role(1100, "ADMIN"), 
				new Role(1102, "BA"), new Role(1103, "QA"));
	...
	public ResponseEntity<Map<Integer, Role>> getRolesMap() {
		...
		Map<Integer, Role> rolesMap = Map.of(1100, new Role(1100, "ADMIN"),
				1102, new Role(1102, "BA"), 1103,
				new Role(1103, "QA"));
